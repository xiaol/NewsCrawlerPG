...
TITLE_PARAM = {
    "method": "find_all",
    "params": {"name": "div", "attrs": {"id": "articletitle"}},
}
POST_DATE_PARAM = {
    "method": "find_all",
    "params": {"name": "div", "attrs": {"id": "articleinfo"}},
}
CONTENT_PARAM = {
    "method": "find_all",
    "params": {"name": "div", "attrs": {"id": "articlecontent"}},
}
...
CATEGORIES = {
    u"M新闻": {
        ...
        u"游戏": ("http://news.missevan.com/news/index?ntype=4", 11, 60, 4),
        ...
        u"电影": ("http://news.missevan.com/news/index?ntype=12", 30, 60, 4),
        u"萌宅": ("http://news.missevan.com/news/index?ntype=13", None),
        u"杂谈": ("http://news.missevan.com/news/index?ntype=14", 18, 60, 3),
