...
CATEGORIES = {
    ...
    u'大国博弈': ('http://platform.sina.com.cn/news/news_list?app_key=2872801998&channel=mil&cat_1=dgby&show_all=0&show_cat=1&show_ext=1&tag=1&format=json&page=1&show_num=50&_=1465713170883', 8, 120, 4),
    ...
    u'互联网': ('http://feed.mix.sina.com.cn/api/roll/get?pageid=204&lid=22&num=30&versionNumber=1.2.8&page=1', 7, 60, 4),
    ...
    u'科学探索': ('http://feed.mix.sina.com.cn/api/roll/get?pageid=207&lid=1795&num=30&versionNumber=1.2.8&page=1', 7, 60, 4),
